...
<template>
  <div class="overlay d-flex justify-content-center align-items-center">
    <div class="suggest-location px-3 py-4 rounded-3 bg-dark">
      <div class="d-flex justify-content-between align-items-center">
        <h5 class="m-0 text-white fw-bold fs-6">Suggest Location</h5>
      ...
      <div class="input-group flex-nowrap custom-border rounded-2 my-2">
        <input
          type="text"
      ...
      <!--          <img src="/piks/united-kingdom.png" alt="" />-->
      <!--          <p class="text-white-50">United Kingdom</p>-->
      <!--        </div>-->
      <!--        <img src="/piks/plus.svg" alt="" />-->
      <!--      </div>-->
      <!--      <div class="d-flex justify-content-between align-items-center mt-2">-->
      <!--        <div class="d-flex align-items-center">-->
      <!--          <img src="/piks/ukraine.png" alt="" />-->
      <!--          <p class="text-white-50">Ukraine</p>-->
      <!--        </div>-->
      <!--        <img src="/piks/plus.svg" alt="" />-->
      <!--      </div>-->
      <div class="d-flex gap-2">
        <button class="w-50 btn btn-outline-primary">Cancel</button>
        <button class="w-50 btn btn-primary">Suggest</button>
      </div>
    </div>
  </div>
</template>
...
.suggest-location {
  width: 370px;
  /* height: 320px; */
  border: 1px solid rgba(255, 255, 255, 0.469);
}
.btn-outline-primary {
