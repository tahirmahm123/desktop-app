...
let launcherOptions = { name: "VPN", isHidden: true }; // isHidden is in use by Windows and Linux implementation (see function: WasOpenedAtLogin())
var autoLauncher = null;

if (Platform() === PlatformEnum.Linux) {
  const fs = require("fs");
  const binaryPath = "/opt/vpn/ui/bin/vpn-ui";
