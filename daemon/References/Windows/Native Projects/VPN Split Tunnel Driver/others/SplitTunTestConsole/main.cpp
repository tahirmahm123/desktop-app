...
// 
//  This file is part of the VPN Client Desktop project.
//  https://github.com/tahirmahm123/vpn-daemon
//

#include <iostream>

#include "../common/SplitTunDrvControl/vpnSplitTunDrvControl.h"
...
int main()
{
	std::wcout << L"Test console for vpn-split-tunnel driver" << std::endl;
