#include "vpnSplitTunDrvControl.h"

#define VPN_ST_SERVICE_NAME L"vpn-split-tunnel"
#define VPN_ST_SERVICE_DISPLAY_NAME L"VPN Split-Tunnel Service"
...
namespace splittun
{
	...
	bool StartDriverAsService(LPCTSTR serviceExe)
	{
		...
		SC_HANDLE schService = CreateService(
			...
			VPN_ST_SERVICE_NAME,    // address of name of service to start
			VPN_ST_SERVICE_DISPLAY_NAME,    // address of display name
	...
	bool StopDriverAsService()
	{
		...
		SC_HANDLE schService = OpenService(
			schSCManager,
			VPN_ST_SERVICE_NAME,	// Service name
			SERVICE_ALL_ACCESS
		);
