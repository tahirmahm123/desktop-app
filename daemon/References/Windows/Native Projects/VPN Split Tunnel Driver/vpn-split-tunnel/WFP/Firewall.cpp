...
namespace wfp
{
	...
	NTSTATUS Start(WDFDEVICE wdfDevice) 
	{
		...
		provider.providerKey = KEY_VPN_ST_PROVIDER;
		provider.displayData.name = const_cast<wchar_t*>(L"VPN Split Tunnel");
		provider.displayData.description = const_cast<wchar_t*>(L"VPN Split Tunnel filters + callouts");
		...
		subLayer.subLayerKey = KEY_VPN_ST_SUBLAYER;
		subLayer.displayData.name = L"VPN Split Tunnel sub-Layer";
		subLayer.displayData.description = L"VPN Split Tunnel sub-Layer for use callouts";
		subLayer.flags = 0;
