...
func implPause() error {
	...
	// TODO: in case of custom DNS from local network - necessary to remove custom-DNS configuration from main (non-vpn) network interface ???
...
func implResume(defaultDNS DnsSettings) error {
	...
	// TODO: in case of custom DNS from local network - necessary to add (restore) custom-DNS configuration to main (non-vpn) network interface ???
